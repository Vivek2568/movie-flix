...
const genAI = new GoogleGenerativeAI("AIzaSyCfjjCefNUK1yZnbMJ81ZZmcCq0_9Eazsk");
const GptBarSearch = () => {
    ...
    const handleGptSearchClick = () => {
        ...
        async function run() {
            ...
            const prompt = "show only 5 name of result of" + searchText.current.value + "give only name in the form of array ";
